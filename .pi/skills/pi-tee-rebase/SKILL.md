---
name: pi-tee-rebase
description: Rebase Anton's fork branch onto the latest upstream release tag, resolving known fork commits including rpc-socket mode, navigate_tree, waitForSettled, and npm fork packaging.
---
...
4. `REVIEW LATER: implement waitForSettled`
