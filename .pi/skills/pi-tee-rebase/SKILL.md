---
name: pi-tee-rebase
description: Rebase Anton's fork branch onto the latest upstream release tag, resolving known fork commits including rpc-socket mode, navigate_tree, RPC image inputs, and npm fork packaging.
---
